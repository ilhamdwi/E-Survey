...
<head>
    ...
    <title>Survey Kepuasan & Contingency Plan </title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <marquee width="300">
                <a style="background-color:#28375a; color:white;" class="navbar-brand" href="#">E-SURVEY Contingeny Plan</a>
                </marquee>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#login" data-toggle="modal"><button class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-log-in"></span> Login(Admin)</button></a></li>
                </ul>
    ...
    <div class="container">
        ...
        <div class="panel panel-default" >
          <div class="panel-body" style="background-color:#e6e6e6;">
            <div class="col-lg-12">
                <img class="img-responsive" src="./images/petikemas.jpg" alt="" style="height:400px;width:1290px">
                <hr>
            </div>
              <div class="row">
                      ...
                      <form method='POST' action='aksi_kuosioner.php' onSubmit=\"return validasisurvey(this)\" >
                          ...
                          <table class="table" > 
                                             ...
                                             <div class="col-sm-3">
                                                 <div class="input-group">
                                                     ...
                                                     <select name="companyProduct" id="produk" class="form-control">
                                                         <option value="Transaksi Impor">Transaksi Impor</option>
                                                         <option value="Transaksi Ekspor">Transaksi Ekspor</option>
                                                         </select>
                                                 </div>
                                             </div>
                                          </div>
                              ...
                              <tr>
                                  ...
                                  penilaian dan masukan kepada terminal petikemas tentang contingency plan supaya mengetahui apakah dapat
                                  dipahami atau tidak.<br>
                                  ...
                                  <td colspan="9">
                                      <table class="table table-striped table-bordered">
                                          <thead>
                                              ...
                                              <th colspan='2'><p align='center'><b><font face='Tahoma' size='2'>PERTANYAAN</font></b></th>
                                              <th colspan="5" bgcolor='#FFFF00'><p align='center'><font face='Tahoma' size='2'>RESPON</font></th>
                                          </thead>
                                          <tbody>
                                              <?php
                                              include "koneksi.php";
                                              ...
                                              while($data = mysql_fetch_array($sql)){
                                                  ...
                                                  echo "<tr valign='top'>
                                                          ...
                                                          <td height='25' width='8%' bgcolor='#000000'><p align='center'><font face='Tahoma' size='1' color='white'>1<br>(Sangat Tidak Setuju)</font></td>
                                                          <td height='25' width='8%' bgcolor='#000000'><p align='center'><font face='Tahoma' size='1' color='white'>2<br>(TIdak Setuju)</font></td>
                                                          <td height='25' width='8%' bgcolor='#000000'><p align='center'><font face='Tahoma' size='1' color='white'>3<br>(Netral)</font></td>
                                                          <td height='25' width='8%' bgcolor='#000000'><p align='center'><font face='Tahoma' size='1' color='white'>4<br>(Setuju)</font></td>
                                                          <td height='25' width='8%' bgcolor='#000000'><p align='center'><font face='Tahoma' size='1' color='white'>5<br>(Sangat Setuju)</font></td>
                                                      </tr>";
                                                  ...
                                                  while ($r = mysql_fetch_array($hasil)){
                                                      ...
                                                      echo "<tr>
                                                              ...
                                                              <td align='center'> <input type='radio' name='asfa$i$data[groupId]' value='1'> </td>
                                                              <td align='center'> <input type='radio' name='asfa$i$data[groupId]' value='2'> </td>
                                                              <td align='center'> <input type='radio' name='asfa$i$data[groupId]' value='3'> </td>
                                                              <td align='center'> <input type='radio' name='asfa$i$data[groupId]' value='4'> </td>
                                                              <td align='center'> <input type='radio' name='asfa$i$data[groupId]' value='5'> </td>
                                                              </tr>";
                                                      $i++;
                                                  }
                                                  echo "<br>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <center>Copyright &copy; Terminal Petikemas X<br> All rights reserved.</center>

...
<head>
    ...
    <title>Admin Terminal Petikemas X</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="master.php">Hallo Admin</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="<?php if($_GET['module']=='description'){echo'active';} ?>">
                        <a href="?module=description"><i class="glyphicon glyphicon-book"></i> Manajemen Pertanyaan</a>
                    </li>

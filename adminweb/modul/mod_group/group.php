...
switch($_GET[act]){
	...
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">
	            <i class="glyphicon glyphicon-user"></i> Manajemen Kategori
	        </h1>
	        <ol class="breadcrumb">
	            <li class="active">
	                 <a href="master.php?module=group">Manajemen Kategori</a>
	            </li>
	        </ol>
	    </div>
	</div>
	<div class="panel panel-primary">
		<div class="panel-heading">
			...
			<div class="panel-title"><span class="glyphicon glyphicon-list"></span> List Kategori Kuisioner <i style="margin-left:750px;"><?php if($_SESSION['level']=="Super"){?><button class="btn btn-success btn-sm " onclick="window.location.href='?module=group&act=tambahgroup'"><span class="glyphicon glyphicon-plus"></span> Tambah Group</button></i><?php } ?></div>
		</div>
		<div class="panel-body">
			<table id="tablekonten" class="table table-striped table-bordered table-responsive" style="">
				<thead>
					...
					<th width="1%"><div id="konten">Kategori ID</div></th>
					<th width="10%"><div id="konten">Nama Kategori</div></th>
	...
	<div class="row">
	    <div class="col-lg-12">
	        ...
	        <ol class="breadcrumb">
	            <li class="active">
	                 <a href="master.php?module=group">Manajemen Kategori</a> / <a href="master.php?module=group&act=tambahgroup">Tambah Group</a>
	            </li>
	        </ol>
	    </div>
	</div>
	<div class="panel panel-primary">
    	<div class="panel-heading">
			<div class="panel-title"><span class="glyphicon glyphicon-list"></span> Tambah Kategor Kuisioner <i style="margin-left:770px;"><button class="btn btn-success btn-sm " onclick="window.location.href='?module=group'"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</button></i></div>
		</div>
		<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<div class="input-group">
							...
							<input type="text" name="grup" class="form-control" placeholder="Nama Kategori">
						</div>
					</div>
				</div>
				<div class="form-group">
